...
namespace MobileGwDataSync.Monitoring.Metrics
{
    public class MetricsService : IMetricsService
    {
        ...
        private static readonly Counter SyncStarted = Prometheus.Metrics
            .CreateCounter("sync_jobs_started_total", "Total number of sync jobs started", "job_name");

        private static readonly Counter SyncCompleted = Prometheus.Metrics
            .CreateCounter("sync_jobs_completed_total", "Total number of sync jobs completed", "job_name", "status");

        private static readonly Counter SyncErrors = Prometheus.Metrics
        ...
        private static readonly Counter RecordsProcessed = Prometheus.Metrics
            .CreateCounter("sync_records_processed_total", "Total number of records processed", "job_name");

        private static readonly Gauge ActiveSyncs = Prometheus.Metrics
